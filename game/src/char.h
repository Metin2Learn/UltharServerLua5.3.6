...
enum EPointTypes
{
	...
	POINT_ATTBONUS_STONE = 138,			//138
	POINT_ATTBONUS_BOSS = 139,			//139
#ifdef ELEMENT_NEW_BONUSES
	POINT_ATTBONUS_ELEC = 140,
	POINT_ATTBONUS_WIND = 141,
	POINT_ATTBONUS_EARTH = 142,
	POINT_ATTBONUS_DARK = 143,
#endif
...
//		bool			IsPet() const		{ return m_bCharType == CHAR_TYPE_PET; }
	...
	public:
		...
		void				AggregateMonsterScope(int maxDistance, int maxMonsters);
		void				AttractRanger();
		void				PullMonster();
