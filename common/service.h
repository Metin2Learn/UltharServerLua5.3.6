...
#define ENABLE_DS_GRADE_MYTH
	...
	#define ENABLE_ANNOUNCEMENT_REFINE_SUCCES_MIN_LEVEL 8 // Put what +level you want to announcement in chat when u upgrade something
	#define ENABLE_ANNOUNCEMENT_REFINE_FAIL_MIN_LEVEL 7
#endif
